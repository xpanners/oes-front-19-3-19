    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="courses"><?php echo $data['ccname']; ?></a></li>
          <li class="list-inline-item text-white h3 font-secondary nasted"><?php echo $data['subject_name']; ?></li>
        </ul>
        <h1 class="text-lighten"><?php echo $data['ctitle']; ?><?php// print_r($data); ?></h1>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 mb-4">
        <!-- course thumb -->
        <img src="http://localhost/lib/images/courses/course-2.jpg" style="max-height:300px" class="img-fluid w-100">
      </div>
    </div>
    <!-- course info -->
          ...
          <li class="list-inline-item mr-4 mb-3 mb-sm-0">
            <div class="d-flex align-items-center">
              ...
              <div class="text-left">
                ...
                <p class="mb-0">PKR: <?php echo $data['fee']; ?></p>
              </div>
            </div>
          </li>
        </ul>
    ...
    <div class="row">
      ...
      <!-- teacher -->
      <div class="col-12">
        <h5 class="mb-3"><a href="#"><?php echo $data['screen_name']; ?></a></h5>
        <div class="d-flex justify-content-between align-items-center flex-wrap">
          <div class="media mb-2 mb-sm-0">
            ...
            <div class="media-body">
              ...
              <div class="col-lg-12">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cumque accusamus tenetur ea harum delectus ab consequatur excepturi, odit qui in quo quia 
              </div>
              </div>
          </div>
